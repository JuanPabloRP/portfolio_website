	...
	return (
		...
		>
			<section className="animate-jump-in animate-once animate-duration-500">
				{/* <p className="md:pr-4 text-4xl text-blue text-center mb-2">
					Hey! I am{' '}
				</p> */}
				<h2 className=" flex flex-col flex-wrap content-center justify-center text-center text-4xl w-auto h-auto max-w-6xl md:text-5xl lg:text-6xl md:mx-auto uppercase 0 ">
					<span className="">Juan Pablo Roldan Patiño</span>
				</h2>
				{/* <p className="mt-3 text-pink text-3xl text-center mx-auto lg:text-4xl" style={{ textShadow: '0 0 30px #fb2576' }}>
					Software Developer
				</p> */}
				<WordRotate
					words={[
